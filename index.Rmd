...
### Based on data in the **Paleobiology Database**, the majority of fossil collections are located in **North America** and **Europe**. A small portion also comes from the East Asian region. {data-commentary-width=600}
...
### Most researchers reporting these fossil collections were also based at institutions in high income countries, leading to a greated imbalance. {data-commentary-width=600}
